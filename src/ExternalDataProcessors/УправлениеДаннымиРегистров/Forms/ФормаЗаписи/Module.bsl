...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ОписаниеРегистра = Неопределено Тогда
		ВызватьИсключение "Не передано описание регистра";
	КонецЕсли;
	
	ОписаниеРегистра = Новый ФиксированнаяСтруктура(Параметры.ОписаниеРегистра);
...
Процедура НастроитьПолеНомерСтроки(Элемент)
	Если ОписаниеРегистра.ПодчинениеРегистратору Тогда
		Элемент.Подсказка = "Новая запись добавится быстрее в регистр, если значение номера строка равно ""0"" и отключен режим ""Обмен данными""";
