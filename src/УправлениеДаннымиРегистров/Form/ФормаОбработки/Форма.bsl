...
Процедура ПриЗакрытииФормыВводаЗаписиНаСервере(ДанныеЗаписи, ДополнительныеПараметры)
	...
	ИначеЕсли ДополнительныеПараметры.Действие = "ЗаменитьЗначенияВыделенные" Тогда
		...
		ЗаменитьЗначенияСтрокНаСервере(ДополнительныеПараметры.ВыделенныеСтроки, ДанныеЗаписи);
...
Процедура ИзменитьЗаписьНаСервере(ДанныеЗаписи, ИзменяемаяЗапись) 
	...
	ЗаменитьЗначенияСтрокНаСервере(МассивСтрок, ДанныеЗаписи);
...
Процедура ЗаменитьЗначенияПоОтборуНаСервере(НовыеЗначения)
	...
	ЗаменитьЗначенияСтрокНаСервере(КоллекцияСтрок, НовыеЗначения);
	
КонецПроцедуры

&НаСервере
Процедура ЗаменитьЗначенияСтрокНаСервере(КоллекцияСтрок, НовыеЗначения)
